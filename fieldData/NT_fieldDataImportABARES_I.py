...
def gettransectdata(tdata):
    ...
    mGl = tdata.col_values(8,2,302)

    mDl = tdata.col_values(9,2,302)

    mB = tdata.col_values(10,2,302)

    iC = tdata.col_values(11,2,302)

    uGl = tdata.col_values(12,2,302)

    uDl = tdata.col_values(13,2,302)

    uB = tdata.col_values(14,2,302)
