...
def fracAnalysis(result):
    ...
    return bare, pV1, npV1, bal, bdl, bareSoil, agg, cryp, ash, branch, ppcWork, ccWork
...
def analysis(data,interUnique):
    ...
    for i in range(size):
	    ...
	    bare, pV1, npV1, bal, bdl, bareSoil, agg, cryp, ash, branch, ppcWork, ccWork = fracAnalysis(result)
